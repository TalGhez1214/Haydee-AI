...
import { job7Embeddings } from '@/lib/inngest/functions/job7-embeddings'

export const { GET, POST, PUT } = serve({
  client: inngest,
  functions: [job1Ingest, job2Character, job3Culture, job4Consistency, job5Untranslatable, job6Translate, job7Embeddings],
})
